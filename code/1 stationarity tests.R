...
adf.results$statistic <- c(adf.test(ts.apsp.monthly.absolute, "stationary", k = 0)$statistic, # k is the number of delta (=phi_1 - 1) lags, here, k = 0 is used to decrease complexity
                           ...
                           adf.test(ts.lng.monthly.absolute, "stationary", k = 0)$statistic,
                           ...
                           adf.test(ts.lng.monthly.difference, "stationary", k = 0)$statistic,
                           ...
                           adf.test(ts.lng.monthly.log.returns, "stationary", k = 0)$statistic,
...
adf.results$p <- c(adf.test(ts.apsp.monthly.absolute, "stationary", k = 0)$p.value,
                   ...
                   adf.test(ts.lng.monthly.absolute, "stationary", k = 0)$p.value,
                   ...
                   adf.test(ts.lng.monthly.difference, "stationary", k = 0)$p.value,
                   ...
                   adf.test(ts.lng.monthly.log.returns, "stationary", k = 0)$p.value,
