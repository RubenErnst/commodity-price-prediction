...
apsp.plot.data$config <- paste(apsp.plot.data$n_tree_category, " trees, mtry = ", apsp.plot.data$mtry)
...
brent.plot.data$config <- paste(brent.plot.data$n_tree_category, " trees, mtry = ", brent.plot.data$mtry)
...
dubai.plot.data$config <- paste(dubai.plot.data$n_tree_category, " trees, mtry = ", dubai.plot.data$mtry)
...
natgas.us.plot.data$config <- paste(natgas.us.plot.data$n_tree_category, " trees, mtry = ", natgas.us.plot.data$mtry)
...
wti.plot.data$config <- paste(wti.plot.data$n_tree_category, " trees, mtry = ", wti.plot.data$mtry)
