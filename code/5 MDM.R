...
nochange.ses <- data.frame("test" = rep("nochange<ses", 6),
                           "commodity" = c("APSP", "Brent", "Dubai Fateh", "LNG Asia", "NatGas Henry Hub", "WTI"),
                           "statistic" = c(dm.test(e1 = rep(ts.apsp.monthly.absolute[(length(ts.apsp.monthly.absolute) - 12)], 12) - ts.apsp.monthly.absolute[(length(ts.apsp.monthly.absolute) - 11):length(ts.apsp.monthly.absolute)],
                                           ...
                                           dm.test(e1 = rep(ts.dubai.monthly.absolute[(length(ts.dubai.monthly.absolute) - 12)], 12) - ts.dubai.monthly.absolute[(length(ts.dubai.monthly.absolute) - 11):length(ts.dubai.monthly.absolute)],
                                                   ...
                                                   alternative = "greater", h = h)$statistic,
                                           dm.test(e1 = rep(ts.lng.monthly.absolute[(length(ts.lng.monthly.absolute) - 12)], 12) - ts.lng.monthly.absolute[(length(ts.lng.monthly.absolute) - 11):length(ts.lng.monthly.absolute)],
                                                   e2 = ses.pred$lng.log.return - ts.lng.monthly.absolute[(length(ts.lng.monthly.absolute) - 11):length(ts.lng.monthly.absolute)],
                                                   alternative = "greater", h = h)$statistic,
...
nochange.arima <- data.frame("test" = rep("nochange<arima", 6),
                           "commodity" = c("APSP", "Brent", "Dubai Fateh", "LNG Asia", "NatGas Henry Hub", "WTI"),
                           "statistic" = c(dm.test(e1 = rep(ts.apsp.monthly.absolute[(length(ts.apsp.monthly.absolute) - 12)], 12) - ts.apsp.monthly.absolute[(length(ts.apsp.monthly.absolute) - 11):length(ts.apsp.monthly.absolute)],
                                           ...
                                           dm.test(e1 = rep(ts.dubai.monthly.absolute[(length(ts.dubai.monthly.absolute) - 12)], 12) - ts.dubai.monthly.absolute[(length(ts.dubai.monthly.absolute) - 11):length(ts.dubai.monthly.absolute)],
                                                   ...
                                                   alternative = "greater", h = h)$statistic,
                                           dm.test(e1 = rep(ts.lng.monthly.absolute[(length(ts.lng.monthly.absolute) - 12)], 12) - ts.lng.monthly.absolute[(length(ts.lng.monthly.absolute) - 11):length(ts.lng.monthly.absolute)],
                                                   e2 = arima.pred$lng.log.return - ts.lng.monthly.absolute[(length(ts.lng.monthly.absolute) - 11):length(ts.lng.monthly.absolute)],
                                                   alternative = "greater", h = h)$statistic,
                                           dm.test(e1 = rep(ts.natgas.us.monthly.absolute[(length(ts.natgas.us.monthly.absolute) - 12)], 12) - ts.natgas.us.monthly.absolute[(length(ts.natgas.us.monthly.absolute) - 11):length(ts.natgas.us.monthly.absolute)],
...
nochange.ann <- data.frame("test" = rep("nochange<ann", 6),
                           "commodity" = c("APSP", "Brent", "Dubai Fateh", "LNG Asia", "NatGas Henry Hub", "WTI"),
                           "statistic" = c(dm.test(e1 = rep(ts.apsp.monthly.absolute[(length(ts.apsp.monthly.absolute) - 12)], 12) - ts.apsp.monthly.absolute[(length(ts.apsp.monthly.absolute) - 11):length(ts.apsp.monthly.absolute)],
                                           ...
                                           dm.test(e1 = rep(ts.dubai.monthly.absolute[(length(ts.dubai.monthly.absolute) - 12)], 12) - ts.dubai.monthly.absolute[(length(ts.dubai.monthly.absolute) - 11):length(ts.dubai.monthly.absolute)],
                                                   ...
                                                   alternative = "greater", h = h)$statistic,
                                           dm.test(e1 = rep(ts.lng.monthly.absolute[(length(ts.lng.monthly.absolute) - 12)], 12) - ts.lng.monthly.absolute[(length(ts.lng.monthly.absolute) - 11):length(ts.lng.monthly.absolute)],
                                                   e2 = ann.pred$lng.log.return - ts.lng.monthly.absolute[(length(ts.lng.monthly.absolute) - 11):length(ts.lng.monthly.absolute)],
                                                   alternative = "greater", h = h)$statistic,
                                           dm.test(e1 = rep(ts.natgas.us.monthly.absolute[(length(ts.natgas.us.monthly.absolute) - 12)], 12) - ts.natgas.us.monthly.absolute[(length(ts.natgas.us.monthly.absolute) - 11):length(ts.natgas.us.monthly.absolute)],
...
nochange.rf <- data.frame("test" = rep("nochange<rf", 6),
                           "commodity" = c("APSP", "Brent", "Dubai Fateh", "LNG Asia", "NatGas Henry Hub", "WTI"),
                           "statistic" = c(dm.test(e1 = rep(ts.apsp.monthly.absolute[(length(ts.apsp.monthly.absolute) - 12)], 12) - ts.apsp.monthly.absolute[(length(ts.apsp.monthly.absolute) - 11):length(ts.apsp.monthly.absolute)],
                                           ...
                                           dm.test(e1 = rep(ts.dubai.monthly.absolute[(length(ts.dubai.monthly.absolute) - 12)], 12) - ts.dubai.monthly.absolute[(length(ts.dubai.monthly.absolute) - 11):length(ts.dubai.monthly.absolute)],
                                                   ...
                                                   alternative = "greater", h = h)$statistic,
                                           dm.test(e1 = rep(ts.lng.monthly.absolute[(length(ts.lng.monthly.absolute) - 12)], 12) - ts.lng.monthly.absolute[(length(ts.lng.monthly.absolute) - 11):length(ts.lng.monthly.absolute)],
                                                   e2 = rf.pred$lng.log.return - ts.lng.monthly.absolute[(length(ts.lng.monthly.absolute) - 11):length(ts.lng.monthly.absolute)],
                                                   alternative = "greater", h = h)$statistic,
                                           dm.test(e1 = rep(ts.natgas.us.monthly.absolute[(length(ts.natgas.us.monthly.absolute) - 12)], 12) - ts.natgas.us.monthly.absolute[(length(ts.natgas.us.monthly.absolute) - 11):length(ts.natgas.us.monthly.absolute)],
...
ses.arima <- data.frame("test" = rep("ses<arima", 6),
                        "commodity" = c("APSP", "Brent", "Dubai Fateh", "LNG Asia", "NatGas Henry Hub", "WTI"),
                        "statistic" = c(dm.test(e1 = ses.pred$apsp.log.return - ts.apsp.monthly.absolute[(length(ts.apsp.monthly.absolute) - 11):length(ts.apsp.monthly.absolute)],
                                        ...
                                        dm.test(e1 = ses.pred$dubai.log.return - ts.dubai.monthly.absolute[(length(ts.dubai.monthly.absolute) - 11):length(ts.dubai.monthly.absolute)],
                                                e2 = arima.pred$dubai.log.return - ts.dubai.monthly.absolute[(length(ts.dubai.monthly.absolute) - 11):length(ts.dubai.monthly.absolute)],
                                                alternative = "greater", h = h)$statistic,
                                        dm.test(e1 = ses.pred$lng.log.return - ts.lng.monthly.absolute[(length(ts.lng.monthly.absolute) - 11):length(ts.lng.monthly.absolute)],
                                                e2 = arima.pred$lng.log.return - ts.lng.monthly.absolute[(length(ts.lng.monthly.absolute) - 11):length(ts.lng.monthly.absolute)],
                                                alternative = "greater", h = h)$statistic,
...
arima.ann <- data.frame("test" = rep("arima<ann", 6),
                        "commodity" = c("APSP", "Brent", "Dubai Fateh", "LNG Asia", "NatGas Henry Hub", "WTI"),
                        "statistic" = c(dm.test(e1 = arima.pred$apsp.log.return - ts.apsp.monthly.absolute[(length(ts.apsp.monthly.absolute) - 11):length(ts.apsp.monthly.absolute)],
                                        ...
                                        dm.test(e1 = arima.pred$dubai.log.return - ts.dubai.monthly.absolute[(length(ts.dubai.monthly.absolute) - 11):length(ts.dubai.monthly.absolute)],
                                                e2 = ann.pred$dubai.log.return - ts.dubai.monthly.absolute[(length(ts.dubai.monthly.absolute) - 11):length(ts.dubai.monthly.absolute)],
                                                alternative = "greater", h = h)$statistic,
                                        dm.test(e1 = arima.pred$lng.log.return - ts.lng.monthly.absolute[(length(ts.lng.monthly.absolute) - 11):length(ts.lng.monthly.absolute)],
                                                e2 = ann.pred$lng.log.return - ts.lng.monthly.absolute[(length(ts.lng.monthly.absolute) - 11):length(ts.lng.monthly.absolute)],
                                                alternative = "greater", h = h)$statistic,
...
arima.rf <- data.frame("test" = rep("arima<rf", 6),
                       "commodity" = c("APSP", "Brent", "Dubai Fateh", "LNG Asia", "NatGas Henry Hub", "WTI"),
                       "statistic" = c(dm.test(e1 = arima.pred$apsp.log.return - ts.apsp.monthly.absolute[(length(ts.apsp.monthly.absolute) - 11):length(ts.apsp.monthly.absolute)],
                                               e2 = rf.pred$apsp.log.return - ts.apsp.monthly.absolute[(length(ts.apsp.monthly.absolute) - 11):length(ts.apsp.monthly.absolute)],
                                               alternative = "greater", h = h)$statistic,
...
ses.ann <- data.frame("test" = rep("ses<ann", 6),
                      "commodity" = c("APSP", "Brent", "Dubai Fateh", "LNG Asia", "NatGas Henry Hub", "WTI"),
                      "statistic" = c(dm.test(e1 = ses.pred$apsp.log.return - ts.apsp.monthly.absolute[(length(ts.apsp.monthly.absolute) - 11):length(ts.apsp.monthly.absolute)],
                                              e2 = ann.pred$apsp.log.return - ts.apsp.monthly.absolute[(length(ts.apsp.monthly.absolute) - 11):length(ts.apsp.monthly.absolute)],
                                              alternative = "greater", h = h)$statistic,
...
ses.rf <- data.frame("test" = rep("ses<rf", 6),
                     "commodity" = c("APSP", "Brent", "Dubai Fateh", "LNG Asia", "NatGas Henry Hub", "WTI"),
                     "statistic" = c(dm.test(e1 = ses.pred$apsp.log.return - ts.apsp.monthly.absolute[(length(ts.apsp.monthly.absolute) - 11):length(ts.apsp.monthly.absolute)],
                                             e2 = rf.pred$apsp.log.return - ts.apsp.monthly.absolute[(length(ts.apsp.monthly.absolute) - 11):length(ts.apsp.monthly.absolute)],
                                             alternative = "greater", h = h)$statistic,
...
rf.ann <- data.frame("test" = rep("rf<ann", 6),
                     "commodity" = c("APSP", "Brent", "Dubai Fateh", "LNG Asia", "NatGas Henry Hub", "WTI"),
                     "statistic" = c(dm.test(e1 = rf.pred$apsp.log.return - ts.apsp.monthly.absolute[(length(ts.apsp.monthly.absolute) - 11):length(ts.apsp.monthly.absolute)],
                                             e2 = ann.pred$apsp.log.return - ts.apsp.monthly.absolute[(length(ts.apsp.monthly.absolute) - 11):length(ts.apsp.monthly.absolute)],
                                             alternative = "greater", h = h)$statistic,
                                     dm.test(e1 = rf.pred$brent.log.return - ts.brent.monthly.absolute[(length(ts.brent.monthly.absolute) - 11):length(ts.brent.monthly.absolute)],
                                             e2 = ann.pred$brent.log.return - ts.brent.monthly.absolute[(length(ts.brent.monthly.absolute) - 11):length(ts.brent.monthly.absolute)],
                                             alternative = "greater", h = h)$statistic,
                                     dm.test(e1 = rf.pred$dubai.log.return - ts.dubai.monthly.absolute[(length(ts.dubai.monthly.absolute) - 11):length(ts.dubai.monthly.absolute)],
                                             e2 = ann.pred$dubai.log.return - ts.dubai.monthly.absolute[(length(ts.dubai.monthly.absolute) - 11):length(ts.dubai.monthly.absolute)],
                                             alternative = "greater", h = h)$statistic,
                                     dm.test(e1 = rf.pred$lng.log.return - ts.lng.monthly.absolute[(length(ts.lng.monthly.absolute) - 11):length(ts.lng.monthly.absolute)],
                                             e2 = ann.pred$lng.log.return - ts.lng.monthly.absolute[(length(ts.lng.monthly.absolute) - 11):length(ts.lng.monthly.absolute)],
                                             alternative = "greater", h = h)$statistic,
                                     dm.test(e1 = rf.pred$natgas.us.log.return - ts.natgas.us.monthly.absolute[(length(ts.natgas.us.monthly.absolute) - 11):length(ts.natgas.us.monthly.absolute)],
                                             e2 = ann.pred$natgas.us.log.return - ts.natgas.us.monthly.absolute[(length(ts.natgas.us.monthly.absolute) - 11):length(ts.natgas.us.monthly.absolute)],
                                             alternative = "greater", h = h)$statistic,
                                     dm.test(e1 = rf.pred$wti.log.return - ts.wti.monthly.absolute[(length(ts.wti.monthly.absolute) - 11):length(ts.wti.monthly.absolute)],
                                             e2 = ann.pred$wti.log.return - ts.wti.monthly.absolute[(length(ts.wti.monthly.absolute) - 11):length(ts.wti.monthly.absolute)],
                                             alternative = "greater", h = h)$statistic),
                     "side" = rep("greater", 6),
                     "p.value" = c(dm.test(e1 = rf.pred$apsp.log.return - ts.apsp.monthly.absolute[(length(ts.apsp.monthly.absolute) - 11):length(ts.apsp.monthly.absolute)],
                                           e2 = ann.pred$apsp.log.return - ts.apsp.monthly.absolute[(length(ts.apsp.monthly.absolute) - 11):length(ts.apsp.monthly.absolute)],
                                           alternative = "greater", h = h)$p.value,
                                   dm.test(e1 = rf.pred$brent.log.return - ts.brent.monthly.absolute[(length(ts.brent.monthly.absolute) - 11):length(ts.brent.monthly.absolute)],
                                           e2 = ann.pred$brent.log.return - ts.brent.monthly.absolute[(length(ts.brent.monthly.absolute) - 11):length(ts.brent.monthly.absolute)],
...
dm.results <- rbind(nochange.ses, nochange.arima, nochange.ann, nochange.rf, ses.arima, arima.ann, arima.rf, ses.ann, ses.rf, rf.ann)
